...
public class HellfireDiveBehaviour : BaseAttackBehaviour
{
    ...
    private IEnumerator DiveSequence()
    {
        ...
        if (activeColumn != null)
        {
            ...
            // Cache the actual world-space damage region — the prefab's localScale.y
        ...
        // Phase 4: Column active � damage per tick while cannon is inside it.
    ...
    private void TryDamageCannonInColumn()
    {
        ...
        // Resolve the live BaseCannon — search up the hierarchy in case the
